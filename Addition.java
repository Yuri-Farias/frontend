...
{ // Aqui ínicia o bloco de código da classe Addition
   ...
   { // Aqui começa o bloco de código do método main      
      String firstNumber = // Aqui é o nome da variável da String
         JOptionPane.showInputDialog("Enter first integer"); // Exibe um diálogo com uma caixa de dados pedindo um número inteiro
      String secondNumber = // Aqui é o nome da segunda variável da String
         JOptionPane.showInputDialog("Enter second integer"); // Exibe um diálogo com uma caixa de dados pedindo um segundo número inteiro
      ...
      JOptionPane.showMessageDialog(null, "The sum is " + sum, // Aqui mostra uma mensagem gerada por parâmetros "The sum is" que vem com a soma 
         "Sum of Two Integers", JOptionPane.PLAIN_MESSAGE); // Aqui é a continuação dos parâmetros após a soma ser feita e acertada, vai aparecer a mensagem de confirmação "Sum Of Two Integers"
