...
public class Calculator extends JFrame{   
    ...
    public Calculator()
    {
        ...
        labell = new JLabel("Digite o número 1:", SwingConstants.RIGHT);
        add(labell);
    ...
    private class TextFieldHandler implements ActionListener 
    {
       ...
       public void actionPerformed(ActionEvent event)
       {
         ...
         if (textField1.getText().trim().length() == 0) {
            // notificar o ususario que o campo 1 está vazio
            lblNotificacao.setText("O campo 1 está vazio!");
            textField1.requestFocus();
         } else {
            if (textField2.getText().trim().length() == 0) {
               // notificar o usuario que o campo 2 está vazio
               lblNotificacao.setText("O campo 1 está vazio");
               textField1.requestFocus();
            } else {
               ...
               lblNotificacao.setText("<html><body>Ops! Parece que foi digitado alguma coisa errada, por favor revisar a digitação, pois podem ser digitados apenas números inteiros.</body></html>");
            }
            }
         }
       } 
