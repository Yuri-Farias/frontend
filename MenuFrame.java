...
public class MenuFrame extends JFrame 
{
   private final Color[] colorValues = 
      {Color.BLACK, Color.BLUE, Color.RED, Color.GREEN, Color.YELLOW, Color.PINK};   
   ...
   public MenuFrame()
   {
      ...
      String[] colors = {"Black", "Blue", "Red", "Green", "Yellow", "Pink"};
      ...
      displayJLabel = new JLabel("†Inzaghi†", SwingConstants.CENTER);
